 ...
 * Mutable state is grouped under APP_STATE. Use setState() for predictable updates.
 */
...
/**
 * Safe state updater. Triggers optional side-effect callback if provided.
 * @param {string} path Dot-notation path (e.g., 'stepper.busy')
 * @param {*} value New value
 * @param {Function|null} [onUpdate] Optional callback after update
 */
